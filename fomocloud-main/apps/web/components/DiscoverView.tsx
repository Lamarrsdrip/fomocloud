...
import {TrendingUp,Users,Sparkles,Flame,Zap,Radio,ArrowUpRight} from "lucide-react";
import {money} from "../lib/api";
import {timeAgo,whaleCount,lifecycleLabel,qualityLabel} from "../lib/format";
import {Empty} from "./Empty";
import {TokenAvatar} from "./TokenAvatar";

const discoverFilters=[["rush","Money Rush",Zap],["trending","Top flow",TrendingUp],["whales","Whales buying",Users],["momentum","Accelerating",Flame],["new","Fresh radar",Sparkles]] as const;
