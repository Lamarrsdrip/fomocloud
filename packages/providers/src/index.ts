...
export class BirdeyeClient{
  ...
  // tags (e.g. "dev","bundler","sniper") is a real, direct per-WALLET insider/risk signal Birdeye
  // already returns on every top_traders row -- previously discarded entirely. A wallet tagged as
