...
export const SMART_MONEY_FILTERS=["all","hot","picks","smart-degens","whales","elite","proven","copyable","platform","new","verifying","cooling"] as const;
export function smartMoneyFilterLabel(f:string){return f==="hot"?"Hot Now":f==="picks"?"MemeCloud Picks":f==="smart-degens"?"Smart Degens":f==="elite"?"Elite":f==="proven"?"Proven":f==="copyable"?"Copyable":f==="platform"?"Platform Added":f==="whales"?"Meme Whales":f==="new"?"Newly Discovered":f==="verifying"?"Being Verified":f==="cooling"?"Cooling":"All"}
