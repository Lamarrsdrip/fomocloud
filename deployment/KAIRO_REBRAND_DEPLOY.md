# KAIRO rebrand deployment

The source package is rebranded to KAIRO. Existing live `fomocloud-*` NSSM services may still exist on the VPS.
...
or keep legacy service names temporarily while pointing them to the new KAIRO working directory. Do not touch XAU/MT5,
