...
| M-46 | Empty/degraded states differentiated | PARTIAL | Fix #27 (Home Pulse, SmartWalletsView) + fix #56 (Admin Global Brain + Whales desks); CommunityView/ActivityView/TradersView reviewed and found to have no pipeline-freshness dependency to report (they reflect this account's own DB rows directly, not an aggregated/computed feed) -- a degraded badge there would be decorative | Admin Tokens tab (discovery-worker-fed) and any other remaining pipeline-dependent surface not yet audited for this distinction |
...
| M-33/35/42/43/46/47, C-13/14/16/17/20/23 | Remaining UX/product redesign — items not yet DONE per the M table above | LARGE | DONE already, not repeated here: Home Pulse (M-41), Token Detail Verdict (M-44), Auto Trade UX (M-45), status-language (C-21). Genuinely still open: full unified Wallet layout (M-33), Add Funds one-tap flow (M-35, NOT STARTED), full Discover section redesign (M-42), Smart Money first-class nav (M-43), empty/degraded states beyond Home+SmartWallets (M-46), Admin Health 2.0 full dashboard with history/charts (M-47) |
